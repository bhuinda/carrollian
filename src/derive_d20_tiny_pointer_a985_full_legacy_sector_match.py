...
STATUS_FULL_MATCH = "D20_TINY_POINTER_A985_FULL_LEGACY_SECTOR_MATCH_CERTIFIED"
...
OUT_FULL_MATCH = THEOREM_ROOT / "tiny_pointer_a985_full_legacy_sector_match"
...
def promote_registered_stage() -> dict[str, Any]:
    ...
    report, _ = wrapper_report(
        ...
        derived={
            ...
            "boundary": "registered support subset only; full 39-sector match is handled by tiny_pointer_a985_full_legacy_sector_match",
        },
    )
    return report
...
def build_full_match() -> dict[str, Any]:
    ...
    report = {
        "schema": "d20.theorem.tiny_pointer_a985_full_legacy_sector_match.source_drop",
        "status": STATUS_FULL_MATCH if all(checks.values()) else "D20_TINY_POINTER_A985_FULL_LEGACY_SECTOR_MATCH_NEEDS_REVIEW",
        "object": "d20",
        "claim": (
    ...
    report["certificate_sha256"] = sha_json({k: v for k, v in report.items() if k != "certificate_sha256"})
    manifest = {
        "schema": "d20.theorem.tiny_pointer_a985_full_legacy_sector_match_manifest.source_drop",
        "name": "tiny_pointer_a985_full_legacy_sector_match",
        "inputs": report["inputs"],
        "outputs": {
...
def update_theorem_index(reports: list[dict[str, Any]]) -> None:
    ...
    new_ids = {
        ...
        "tiny_pointer_a985_full_legacy_sector_match",
    }
    ...
    for theorem_id, report, out_dir in [
        ...
        ("tiny_pointer_a985_full_legacy_sector_match", reports[2], OUT_FULL_MATCH),
    ]:
        theorems.append(
            {
                "id": theorem_id,
