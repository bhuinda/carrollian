...
THEOREM_ID = "sector33_unique_public_zero_support"
...
def build_theorem() -> dict[str, Any]:
    ...
    checks = {
        ...
        "sector33_is_unique_single_sector_public_zero_support": public_zero_sectors == [33]
    ...
    status = (
        ...
        if all_checks_pass
        else "D20_SECTOR33_UNIQUE_PUBLIC_ZERO_SUPPORT_NEEDS_REVIEW"
    )

    sector33_row = next(row for row in sector_rows if row["sector"] == 33)
    report = {
        "schema": "d20.theorem.sector33_unique_public_zero_support.source_drop",
        "status": status,
        "object": "d20",
        "claim": (
            ...
            "verifier field, any single-sector public-zero height support must be Pi_33."
        ),
        "definition": {
            ...
            "public_zero_support": "A sector idempotent e_s with q42(e_s)=0 and q12(e_s)=0.",
...
def write_theorem(out_dir: Path = DEFAULT_OUT_DIR) -> dict[str, Any]:
    ...
    manifest = {
        "schema": "d20.theorem.sector33_unique_public_zero_support_manifest.source_drop",
        "name": THEOREM_ID,
        ...
        "certification_tests": [
            ...
            "verify sector 33 is the unique single-sector public-zero support",
        ],
    }
