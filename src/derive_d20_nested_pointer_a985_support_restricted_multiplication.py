...
STATUS = "D20_NESTED_POINTER_A985_SUPPORT_RESTRICTED_MULTIPLICATION_TABLES_CERTIFIED"
THEOREM_ID = "nested_pointer_a985_support_restricted_multiplication_tables"
...
SUPPORT_COO_DIR = D20_INVARIANTS / "theorems" / "nested_pointer_a985_support_full_matrix_unit_orbital_coo"
...
def build_support_multiplication(max_exhaustive_basis: int, top_sample_products: int, seed: int) -> dict[str, Any]:
    ...
    checks = {
        ...
        == "D20_NESTED_POINTER_A985_SUPPORT_FULL_MATRIX_UNIT_ORBITAL_COO_CERTIFIED"
    ...
    report = {
        "schema": "d20.theorem.nested_pointer_a985_support_restricted_multiplication_tables.source_drop",
        "status": STATUS if all(checks.values()) else "D20_NESTED_POINTER_A985_SUPPORT_RESTRICTED_MULTIPLICATION_TABLES_NEEDS_REVIEW",
        "object": "d20",
    ...
    manifest = {
        "schema": "d20.theorem.nested_pointer_a985_support_restricted_multiplication_tables_manifest.source_drop",
        "name": THEOREM_ID,
...
def verify_support_multiplication() -> dict[str, Any]:
    ...
    return {
        "status": "D20_NESTED_POINTER_A985_SUPPORT_RESTRICTED_MULTIPLICATION_TABLES_VERIFIED"
        if all(checks.values())
        else "D20_NESTED_POINTER_A985_SUPPORT_RESTRICTED_MULTIPLICATION_TABLES_VERIFY_FAILED",
        "checks": checks,
        "all_checks_pass": all(checks.values()),
    }
