...
COMPLETED_FULL_SCRATCH_STEPS = [
    ...
    "from the formula-derived coorient generators, close Gamma of order 9216",
    "compute the six Gamma point orbits and 985 ordered-pair orbitals without using the supplied orbital partition",
    ...
    "derive packet20 C20 from Gamma stabilizer orders and the marked D6 polarity divisor formula",
