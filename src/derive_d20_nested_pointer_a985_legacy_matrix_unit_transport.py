...
STATUS = "D20_NESTED_POINTER_A985_LEGACY_MATRIX_UNIT_TRANSPORT_CERTIFIED"
THEOREM_ID = "nested_pointer_a985_legacy_matrix_unit_transport"
...
def build_transport() -> dict[str, Any]:
    ...
    checks = {
        "full_match_is_certified": full_match.get("status") == "D20_NESTED_POINTER_A985_FULL_LEGACY_SECTOR_MATCH_CERTIFIED"
    ...
    report = {
        "schema": "d20.theorem.nested_pointer_a985_legacy_matrix_unit_transport.source_drop",
        "status": STATUS if all(checks.values()) else "D20_NESTED_POINTER_A985_LEGACY_MATRIX_UNIT_TRANSPORT_NEEDS_REVIEW",
        "object": "d20",
        "claim": (
    ...
    manifest = {
        "schema": "d20.theorem.nested_pointer_a985_legacy_matrix_unit_transport_manifest.source_drop",
        "name": THEOREM_ID,
...
def verify_transport() -> dict[str, Any]:
    ...
    return {
        "status": "D20_NESTED_POINTER_A985_LEGACY_MATRIX_UNIT_TRANSPORT_VERIFIED"
        if all(checks.values())
        else "D20_NESTED_POINTER_A985_LEGACY_MATRIX_UNIT_TRANSPORT_VERIFY_FAILED",
        "checks": checks,
        "all_checks_pass": all(checks.values()),
    }
