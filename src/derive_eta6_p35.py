...
DERIVE_SCRIPT = ROOT / "src" / "derive_eta6_p35.py"
VALIDATOR_SCRIPT = ROOT / "src" / "certify_eta6_p35.py"
...
OBS_CODES = {
    ...
    "p31_top512_worst_spread": 2,
    "p31_top512_worst_p31_id": 3,
    ...
    "p33_basin_floor": 16,
    "p34_basin_floor": 17,
    "p35_basin_min_spread": 18,
    "basin_min_below_p34_flag": 19,
    "basin_min_below_p33_flag": 20,
    "basin_min_below_p32_flag": 21,
    "basin_min_below_p31_flag": 22,
    "basin_min_below_p30_flag": 23,
    "basin_min_below_p29_flag": 24,
    "basin_min_below_p28_flag": 25,
    "below_p34_candidate_count": 26,
    "below_p33_candidate_count": 27,
    "below_p32_candidate_count": 28,
    "below_p31_candidate_count": 29,
    "below_p30_candidate_count": 30,
    "below_p29_candidate_count": 31,
    "below_p28_candidate_count": 32,
    "below_p27_candidate_count": 33,
    "below_p25_candidate_count": 34,
    "support_equal_candidate_count": 35,
    "best_p35_id": 36,
    "best_p25_a": 37,
    "best_p25_b": 38,
    "best_p25_c": 39,
    ...
    "best_p25_e": 41,
    "best_p25_f": 42,
    "best_source_count": 43,
    "best_source_min_rank": 44,
    "best_source_max_rank": 45,
    "best_face_a": 46,
    "best_face_b": 47,
    "best_face_c": 48,
    "best_face_d": 49,
    "best_face_e": 50,
    "best_face_f": 51,
    "best_same_face_spread": 52,
    "best_same_face_p35_id": 53,
    "best_same_mask_spread": 54,
    "best_same_mask_p35_id": 55,
    "best_source_rank0_spread": 56,
    "best_source_rank0_p35_id": 57,
    "best_low128_spread": 58,
    "best_low128_p35_id": 59,
    "p26_horizon_component_count": 60,
    "p26_checked_positive_row_total": 61,
    "p26_min_component_margin": 62,
    "compound_horizon_margin": 63,
    "compound_horizon_strict_flag": 64,
    "p26_margin_preserved_flag": 65,
}
...
def build_p35_rows() -> dict[str, Any]:
    ...
    best_low128: dict[str, int] | None = None
    below_p34 = 0
    below_p33 = 0
    below_p32 = 0
    below_p31 = 0
    ...
    for p35_id, (candidate, source_rank_set) in enumerate(sorted(candidates.items())):
        ...
        if row["source_min_rank"] == 0 and (
            ...
            < (
                ...
                best_source_rank0["p35_id"],
            )
        ):
            best_source_rank0 = row
        if row["source_min_rank"] < 128 and (
            best_low128 is None
            or key
            < (
                best_low128["joint_support_spread"],
                best_low128["p35_id"],
            )
        ):
            best_low128 = row
    ...
    if (
        ...
        or best_low128 is None
    ):
        raise ValueError("empty p35 search")
    best_rows = sorted(
        best_rows,
        key=lambda value: (value["joint_support_spread"], value["p35_id"]),
    )[:TOP_N]
    ...
    obs = {
        ...
        "p31_top512_worst_spread": seeds[-1]["joint_support_spread"],
        "p31_top512_worst_p31_id": seeds[-1]["p31_id"],
        ...
        "p35_basin_min_spread": best_any["joint_support_spread"],
        ...
        "best_same_face_p35_id": best_same_face["p35_id"],
        "best_same_mask_spread": best_same_mask["joint_support_spread"],
        "best_same_mask_p35_id": best_same_mask["p35_id"],
        "best_source_rank0_spread": best_source_rank0["joint_support_spread"],
        "best_source_rank0_p35_id": best_source_rank0["p35_id"],
        "best_low128_spread": best_low128["joint_support_spread"],
        "best_low128_p35_id": best_low128["p35_id"],
...
def build_payloads() -> dict[str, Any]:
    ...
    checks = {
        ...
        "basin_size_matches": (
            ...
            obs["p31_top512_worst_spread"],
            obs["p31_top512_worst_p31_id"],
        ...
        == (144, 512, 6_868_800, 172_526_936, 71_168, 71_105, 63, 63, 2),
        "basin_improves_p34_only": (
            obs["p34_basin_floor"],
            obs["p33_basin_floor"],
            obs["p32_seeded_floor"],
            obs["p31_quint_floor"],
            obs["p30_bounded_floor"],
            obs["p35_basin_min_spread"],
        ...
        == (6_796_608, 7_982_592, 7_541_600, 1_815_040, 4_213_120, 4_589_696, 1, 1, 1, 0, 0, 0, 0),
        ...
        == (72, 213, 153, 0, 0, 0, 0, 909, 1_168, 0),
        ...
        == (42_192, 12, 21, 32, 36, 48, 126, 1, 436, 436, 12, 12, 12, 12, 22, 26),
        "best_same_face_and_mask_match": (
            obs["best_same_face_spread"],
            obs["best_same_face_p35_id"],
            obs["best_same_mask_spread"],
            obs["best_same_mask_p35_id"],
        )
        == (5_769_408, 13_409, 5_769_408, 13_409),
        "source_controls_match": (
            obs["best_source_rank0_spread"],
            obs["best_source_rank0_p35_id"],
            obs["best_low128_spread"],
            obs["best_low128_p35_id"],
        )
        == (10_529_536, 6_053, 6_796_608, 42_977),
    ...
    witness = {
        "classification": "p35_descent",
        "candidate_construction": "p31 top-512 rows + one p25 row",
        ...
        "p35_basin_min_spread": obs["p35_basin_min_spread"],
        ...
        "seed_worst_spread": obs["p31_top512_worst_spread"],
        ...
        "horizon_reading": "p35 improves the six-move basin floor but still does not cross p30/p31 or equalize support.",
        "claim_boundary": {
            "p31_top512_basin_screen": 1,
    ...
    p35 = {
        ...
        "object": "eta6",
        "construction": {
            "source": "p31 top-512 + p25",
            "test": "p35 basin screen",
            "classification": witness["classification"],
        },
        "witness": witness,
    }
    report = {
        "schema": "eta6.p35.report@1",
        "status": STATUS if all(checks.values()) else "ETA6_P35_PROVISIONAL",
        "all_checks_pass": all(checks.values()),
        "claim": (
            "p35 checks 71105 sextuples from the p31 top-512 basin. Best spread "
            "4589696 beats p34, but remains above p31/p30; no equalizer; "
            "p26 margin strict."
        ),
        "stage_protocol": {
            "draft": "rescan complete p31 top-512 and p26 margin",
            "witness": "extend each p31 top-512 row by one p25 row",
            "coherence": "compare p35 against p34..p25 floors",
            "closure": "certify p35 basin descent without support crossing",
            "emit": "emit p35 artifacts and p36 seam",
        },
        "inputs": {
        ...
        "closure_boundary": {
            "certifies": [
                "p35 screen: 71105 candidates",
                "p35 beats p34",
                "p35 best spread is 4589696",
                "no p35 raw-support equalizer",
        ...
        "next_highest_yield_item": (
            "p36: expand to p31 top-2048, unless branch-bound pruning becomes cheaper."
        ),
    }
    report["certificate_sha256"] = self_hash(report, "certificate_sha256")
    cert = {
        "schema": "eta6.p35.cert@1",
        "status": report["status"],
        "checks": checks,
        "witness": witness,
    }
    manifest = {
        "schema": "eta6.p35.manifest@1",
        "name": THEOREM_ID,
        "status": report["status"],
...
def write_payloads(payloads: dict[str, Any]) -> None:
    ...
    write_json(OUT_DIR / "p35.json", payloads["p35"])
