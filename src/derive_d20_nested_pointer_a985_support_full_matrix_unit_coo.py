...
from src.derive_d20_nested_pointer_a985_block_matrix_units import (  # noqa: E402
    FIELD_PRIME,
    RELATION_COUNT,
...
STATUS = "D20_NESTED_POINTER_A985_SUPPORT_FULL_MATRIX_UNIT_ORBITAL_COO_CERTIFIED"
THEOREM_ID = "nested_pointer_a985_support_full_matrix_unit_orbital_coo"
...
FULL_COO_DIR = D20_INVARIANTS / "theorems" / "nested_pointer_a985_full_matrix_unit_orbital_coo"
...
def build_support_full_coo() -> dict[str, Any]:
    ...
    checks = {
        ...
        == "D20_NESTED_POINTER_A985_REGISTERED_SUPPORT_MATRIX_UNITS_CERTIFIED"
        ...
        == "D20_NESTED_POINTER_A985_FULL_MATRIX_UNIT_ORBITAL_COO_CERTIFIED"
    ...
    report = {
        "schema": "d20.theorem.nested_pointer_a985_support_full_matrix_unit_orbital_coo.source_drop",
        "status": STATUS if all(checks.values()) else "D20_NESTED_POINTER_A985_SUPPORT_FULL_MATRIX_UNIT_ORBITAL_COO_NEEDS_REVIEW",
        "object": "d20",
    ...
    manifest = {
        "schema": "d20.theorem.nested_pointer_a985_support_full_matrix_unit_orbital_coo_manifest.source_drop",
        "name": THEOREM_ID,
...
def verify_support_full_coo() -> dict[str, Any]:
    ...
    return {
        "status": "D20_NESTED_POINTER_A985_SUPPORT_FULL_MATRIX_UNIT_ORBITAL_COO_VERIFIED"
        if all(checks.values())
        else "D20_NESTED_POINTER_A985_SUPPORT_FULL_MATRIX_UNIT_ORBITAL_COO_VERIFY_FAILED",
        "checks": checks,
        "all_checks_pass": all(checks.values()),
    }
