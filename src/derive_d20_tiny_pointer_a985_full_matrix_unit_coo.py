...
from src.derive_d20_tiny_pointer_a985_block_matrix_units import (
    FIELD_PRIME,
    RELATION_COUNT,
...
STATUS = "D20_TINY_POINTER_A985_FULL_MATRIX_UNIT_ORBITAL_COO_CERTIFIED"
THEOREM_ID = "tiny_pointer_a985_full_matrix_unit_orbital_coo"
...
def build_full_coo(seed: int, max_trials: int, sample_products: int) -> dict[str, Any]:
    ...
    report = {
        ...
        "status": STATUS if all(checks.values()) else "D20_TINY_POINTER_A985_FULL_MATRIX_UNIT_ORBITAL_COO_NEEDS_REVIEW",
        "object": "d20",
    ...
    manifest = {
        "schema": "d20.theorem.tiny_pointer_a985_full_matrix_unit_orbital_coo_manifest.source_drop",
        "name": THEOREM_ID,
...
def verify_full_coo() -> dict[str, Any]:
    ...
    return {
        ...
        else "D20_TINY_POINTER_A985_FULL_MATRIX_UNIT_ORBITAL_COO_VERIFY_FAILED",
        "checks": checks,
        "all_checks_pass": all(checks.values()),
    }
