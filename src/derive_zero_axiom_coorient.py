...
def derive() -> dict[str, Any]:
    ...
    axioms = {
        ...
        "A4_coorient_lift": "lift operators preserve two-sided coherent signatures and close to Gamma of order 9216",
    ...
    theorem = {
        ...
        "proved_inside_bundle": [
            ...
            "once the coorient lift images are supplied, every large object is regenerated: Gamma, 985 orbitals, T985, quotients, optics, integrity, H-cycles, game layer",
        ],
