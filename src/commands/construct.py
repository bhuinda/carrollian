...
def main() -> None:
    ...
    ap.add_argument("--strict-scratch", action="store_true", help="Exit nonzero unless the bundle contains a full H8^3 -> Gamma -> A985 constructor.")
    ap.add_argument("--from-source", action="store_true", help="Generate H8^3 -> G24 -> 2576 dodecads from scratch and report the remaining Gamma/T985 boundary.")
    ...
    ap.add_argument("--recover-be3-from-orbitals", action="store_true", help="Recover a Gamma action and compact generators from the supplied ordered-pair orbital partition.")
    ap.add_argument("--from-source-coorient", action="store_true", help="Generate H8^3 -> G24 -> dodecads, apply fixed coorient generators to construct Gamma orbitals, and rebuild T985.")
    ...
    ap.add_argument("--derive-coorient-formula-obstruction", action="store_true", help="Prove the fixed coorient Gamma generators are not ordinary 24-coordinate Golay permutations.")
    ...
    ap.add_argument("--derive-lifted-coorient-generators", action="store_true", help="Derive full lifted Gamma coorient generator permutations from the smaller coherent-signature base-image formula.")
    ...
    ap.add_argument("--derive-packet20-c20", action="store_true", help="Derive packet-20 C20 from Gamma stabilizer orders and the marked D6 polarity divisor formula, without reading constants.json as constructor input.")
    ...
    ap.add_argument("--derive-lifted-coorient-generators-canonical", action="store_true", help="Derive full lifted Gamma coorient generator permutations from the canonical 15-integer coherent-signature marker.")
