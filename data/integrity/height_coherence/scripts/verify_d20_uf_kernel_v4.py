#!/usr/bin/env python3
"""Verifier for D20 UF kernel v4: height coherence certificates."""
...
def main() -> None:
    ...
    certificate = {
        'schema': 'd20.uf_kernel.height_coherence.v4',
    ...
    report = f"""# D20 UF Kernel v4: height coherence
...
```
"""
    (outdir / 'd20_uf_kernel_v4_report.md').write_text(report, encoding='utf-8')
