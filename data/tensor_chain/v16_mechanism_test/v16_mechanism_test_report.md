# v16 — mechanism vs defect test for `R_Omega`
...
- **for the full 16×16 `R_Omega` e-lock:** not certified from the current v8 Fano resolution.
...
defect_reading_status: Rejected for six-channel shadow; not decidable for full R_Omega with current v8-resolved Fano data.
