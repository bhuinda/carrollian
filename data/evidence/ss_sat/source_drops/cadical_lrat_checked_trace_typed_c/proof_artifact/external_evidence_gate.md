# External Evidence Gate cadical_lrat_checked_trace_typed_c

cadical_lrat_checked_trace_typed_c preserves the positive external proof-evidence gate and adds native checked LRAT proof-route evidence.
