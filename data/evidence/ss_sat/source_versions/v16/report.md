# G^natural Ontological Computation v16

## Scope

v16 hardens the external-evidence gate. v15 built the harness and found no third-party solver or proof tools on the sandbox PATH. v16 adds a dropbox, cross-platform runner scripts, an external evidence manifest schema, a deterministic external-log analyzer, and a no-evidence audit.
