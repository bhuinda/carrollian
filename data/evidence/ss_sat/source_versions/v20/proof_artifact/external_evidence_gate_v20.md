# External Evidence Gate v20

v20 adds native FRAT evidence and records two verification seams:

```text
standalone FRAT checker = not found locally
legacy full-FRAT route-rank analyzer = blocked by route explosion
```
...
- The full FRAT surface is typed `C` by the v20 classifier.
