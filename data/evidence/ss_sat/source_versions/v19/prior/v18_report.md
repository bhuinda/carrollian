# G^natural Ontological Computation v18

## Scope

v18 promotes the v17 CaDiCaL evidence package from verified external DRAT proof evidence to a typed proof-route audit against the C/V/X integrity ladder.
...
The v18 classifier parses the emitted textual DRAT proof lines and compares every proof-line event against the DIMACS variable boundary.
