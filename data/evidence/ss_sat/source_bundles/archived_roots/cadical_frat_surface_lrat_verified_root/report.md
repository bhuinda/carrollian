# G^natural Ontological Computation cadical_frat_surface_lrat_verified

## Scope

cadical_frat_surface_lrat_verified adds native textual FRAT proof evidence after the cadical_lrat_checked_trace_typed_c native LRAT package.
...
No standalone FRAT checker or FRAT-to-LRAT checker was found in the local tree. cadical_frat_surface_lrat_verified therefore does not claim full external FRAT-format verification.

Instead, cadical_frat_surface_lrat_verified verifies the checked derivation content embedded in the FRAT files:
...
The inherited external route-rank analyzer was designed for smaller DRAT/LRAT proof surfaces. It timed out on the full FRAT surface because FRAT has 214 proof-line events and the inherited degree-5 route-rank stage enumerates proof-route combinations.
...
The full FRAT surface is therefore classified by the C/V/X surface audit, not by the inherited route-rank analyzer.

## C/V/X FRAT Surface Audit

The cadical_frat_surface_lrat_verified classifier parses FRAT as:
