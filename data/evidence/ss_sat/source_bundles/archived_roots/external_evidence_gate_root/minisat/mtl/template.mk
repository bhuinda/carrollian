##
##  Template makefile for Standard, Profile, Debug, Release, and Release-static builds
##
##    eg: "make rs" for a statically linked release build.
##        "make d"  for a debug build (no optimizations).
##        "make"    for the standard build (optimized, but with debug information and assertions active)
