# G^natural Ontological Computation cadical_lrat_checked_trace_typed_c

## Scope

cadical_lrat_checked_trace_typed_c promotes the cadical_drat_trace_typed_c textual DRAT proof-route classification to native textual LRAT proof evidence.
...
The event count and rank summary differ from cadical_drat_trace_typed_c because LRAT is a checked proof format with clause identifiers and antecedent hints, not the same textual DRAT surface. This is expected and is recorded as a separate witness.
...
The cadical_lrat_checked_trace_typed_c classifier parses LRAT as:
