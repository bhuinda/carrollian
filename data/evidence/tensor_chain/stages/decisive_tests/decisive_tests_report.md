# source_drop decisive tests for R_Omega

## Scope

This pass runs the next tests after the Fano-to-6j construction: seven-null-point sweep, Spin12 foam lift, mode-by-mode 6j typing, rank-lock truncation, and shuffle controls. The tests use the source_drop three-zone Fano data; seven-point distributions are reconstructed by uniform splitting inside `L3\P1` and `F7\L3`.
