...
def main() -> None:
    ...
    formulas = {
        "schema": "d20.a985_relation_level_stack_series.formulas",
    ...
    source_summary = {
        "schema": "d20.a985_relation_level_stack_series.sources",
    ...
    report = f"""# D20 A985 Relation-Level Stack Series source_drop
...
"""
    ...
    certificate = {
        "schema": "d20.a985_relation_level_stack_series.source_drop",
    ...
    manifest = {
        "package": "d20_a985_relation_level_stack_series",
        "status": STATUS,
