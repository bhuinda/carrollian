# D20 A985 Relation-Pair Quotient Stack Series v29

## Result

```text
D20_A985_RELATION_PAIR_QUOTIENT_STACK_SERIES_CERTIFIED_MOTIVIC_COHA_OPEN
```
...
```text
nonzero relation pairs = 198029
zero relation pairs = 772196
q42 tensor matches supplied = True
q12 tensor matches supplied = True
q42 -> q12 consistent = True
```
