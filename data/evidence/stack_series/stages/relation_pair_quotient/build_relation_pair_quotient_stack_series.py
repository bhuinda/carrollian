...
def main() -> None:
    ...
    source = {
        "schema": "d20.a985_relation_pair_quotient_stack_series.sources",
    ...
    formulas = {
        "schema": "d20.a985_relation_pair_quotient_stack_series.formulas",
    ...
    report = f"""# D20 A985 Relation-Pair Quotient Stack Series source_drop
...
"""
    ...
    certificate = {
        "schema": "d20.a985_relation_pair_quotient_stack_series.source_drop",
    ...
    manifest = {
        "package": "d20_a985_relation_pair_quotient_stack_series",
        "status": STATUS,
